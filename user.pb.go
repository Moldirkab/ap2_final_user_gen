...
const file_proto_user_proto_rawDesc = "" +
	...
	"\x05valid\x18\x03 \x01(\bR\x05valid2\xb2\x01\n" +
	"\vUserService\x125\n" +
	...
	"\rValidateToken\x12\x12.user.TokenRequest\x1a\x16.user.ValidateResponseB\x14Z\x12user-service/protob\x06proto3"
...
var file_proto_user_proto_goTypes = []any{
	...
	(*ValidateResponse)(nil), // 4: user.ValidateResponse
}
var file_proto_user_proto_depIdxs = []int32{
	...
	2, // 2: user.UserService.ValidateToken:input_type -> user.TokenRequest
	3, // 3: user.UserService.Register:output_type -> user.AuthResponse
	3, // 4: user.UserService.Login:output_type -> user.AuthResponse
	4, // 5: user.UserService.ValidateToken:output_type -> user.ValidateResponse
